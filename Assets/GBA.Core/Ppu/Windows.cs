...
namespace GameboyAdvanced.Core.Ppu
{
    public class Windows
    {
        ...
        internal void Reset()
        {
            ...
            Array.Clear(BgEnableInside[0], 0, BgEnableInside[0].Length);
            Array.Clear(BgEnableInside[1], 0, BgEnableInside[1].Length);
            Array.Clear(ObjEnableInside, 0, ObjEnableInside.Length);
            Array.Clear(ColorSpecialEffectEnableInside, 0, ColorSpecialEffectEnableInside.Length);

            Array.Clear(BgEnableOutside, 0, BgEnableOutside.Length);
            ObjEnableOutside = false;
            ColorSpecialEffectEnableOutside = false;

            Array.Clear(ObjWindowBgEnable, 0, ObjWindowBgEnable.Length);
